...
import { PrintTemplateHeader, PrintTemplateFooter, PrintTemplateHeaderPok, PrintTemplateFooterPok, PrintTemplateHeader2Juego, PrintTemplate2Juego} from "../components"
...
export const initControler = (pagesRender) => {
  ...
  switch (pagesRender) {
    ...
    case "Dashboard":
      ...
      break;
    case "TresEnRaya":
      PrintTemplateHeader2Juego();
      PrintTemplate2Juego();
      PrintAhorcadoPage();
      document.querySelector("header").style.backgroundColor = "#c1c101";
      document.querySelector("footer").style.backgroundColor = "#c1c101";
